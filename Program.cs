    ...
    */
    ...
    public class AddressBook{
        public void AddContact(Contact contact){
            try{
            myContacts.Add(contact.Email, contact);
            }
            catch(ArgumentException ex)
            {Console.WriteLine($"{contact.FullName()} has already been added");}
        }

        public Contact GetByEmail(string email){
            // return myContacts[email];
            foreach  (KeyValuePair<string, Contact> kvp in myContacts)
            {
                if (email == kvp.Key)
                {
                    return kvp.Value;
    ...
    static void Main(string[] args)
    {
        ...
        {  try
        {
            ...
            Console.WriteLine($@"
-------------------------------------------
{email} was not found in your address book");
        }
        }
    }
}
